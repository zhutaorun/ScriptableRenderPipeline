...
float ComputeLuminanceAdaptation(float previousLuminance, float currentLuminance, float deltaTime, float speed)
{
    // Exponential decay
    return previousLuminance + (currentLuminance - previousLuminance) * (1.0 - exp(-deltaTime * speed));
}
