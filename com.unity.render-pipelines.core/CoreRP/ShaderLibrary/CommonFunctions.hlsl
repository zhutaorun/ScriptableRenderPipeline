...
float3x3 BuildWorldToTangent(float3 tangentWS, float3 normalWS, float flipSign)
{
    ...
    float3x3 worldToTangent = CreateWorldToTangent(unnormalizedNormalWS, tangentWS, flipSign);
