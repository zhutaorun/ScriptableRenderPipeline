...
public class HDRP_TestSettings : GraphicsTestSettings
{
	...
	[ContextMenu("Set Game View Size")]
	void SetGameViewSize()
	{
		...
		GameViewUtils.AddCustomSize( GameViewUtils.GameViewSizeType.FixedResolution, GameViewSizeGroupType.Standalone, ImageComparisonSettings.TargetWidth, ImageComparisonSettings.TargetHeight, testGameViewSize );
