...
namespace UnityEngine.Experimental.Rendering.LightweightPipeline
{
    ...
    public sealed partial class LightweightRenderPipeline : RenderPipeline
    {
            ...
            int maxVisibleAdditionalLights, int maxPerObjectAdditionalLights, out RenderingData renderingData)
        {
            ...
            InitializeShadowData(settings, mainLightCastShadows, additionalLightsCastShadows, out renderingData.shadowData);
            renderingData.supportsDynamicBatching = settings.supportsDynamicBatching;
        }

        static void InitializeShadowData(PipelineSettings settings, bool mainLightCastShadows, bool additionalLightsCastShadows, out ShadowData shadowData)
        {
