Shader "LightweightPipeline/Vegetation (Physically Based)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment VegetationPassFragment

            #include "LightweightVegetation.hlsl"
            #include "LWRP/ShaderLibrary/InputSurfacePBR.hlsl"
            #include "LWRP/ShaderLibrary/LightweightPassLit.hlsl"

            half4 VegetationPassFragment(LightweightVertexOutput IN, half facing : VFACE) : SV_Target
            {
