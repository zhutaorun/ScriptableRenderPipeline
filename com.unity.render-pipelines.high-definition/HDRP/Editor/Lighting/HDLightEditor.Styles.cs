...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    partial class HDLightEditor
    {
        sealed class Styles
        {
            ...
            public readonly GUIContent volumetricDimmer = new GUIContent("Volumetric Multiplier", "Allows to reduce the intensity of the scattered volumetric lighting.");
            ...
            public readonly GUIContent shadowSoftness = new GUIContent("Penumbra Softness", "");
            public readonly GUIContent shadowMinimumSoftness = new GUIContent("Minimum Penumbra Softness", "");
