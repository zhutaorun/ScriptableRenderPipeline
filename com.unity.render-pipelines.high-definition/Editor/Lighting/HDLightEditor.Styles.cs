...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    partial class HDLightEditor
    {
        sealed class Styles
        {
            ...
            public readonly GUIContent lightRadius = new GUIContent("Light Radius", "Controls the size of the sphere light. For point and spot lights, it only affects volumetric lighting.");
