...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    class RenderPipelineSettingsUI : BaseUI<SerializedRenderPipelineSettings>
    {
        ...
        static void Drawer_SectionPrimarySettings(RenderPipelineSettingsUI s, SerializedRenderPipelineSettings d, Editor o)
        {
            ...
            EditorGUILayout.PropertyField(d.supportedRenderingPath, _.GetContent("Supported Shader Lit Mode|Remove all the memory and shader variant of GBuffer of non used mode. The renderer cannot be switch to non selected path anymore."));
            ...
            {
                ++EditorGUI.indentLevel;
                d.supportMSAA.boolValue = EditorGUILayout.Toggle(_.GetContent("Support Multi Sampling Anti-Aliasing|This feature doesn't work currently."), d.supportMSAA.boolValue && isForwardOnly);
