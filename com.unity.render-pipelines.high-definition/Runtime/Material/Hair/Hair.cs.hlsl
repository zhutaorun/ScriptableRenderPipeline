...
//
#define DEBUGVIEW_HAIR_SURFACEDATA_MATERIAL_FEATURES (1300)
#define DEBUGVIEW_HAIR_SURFACEDATA_BASE_COLOR (1301)
#define DEBUGVIEW_HAIR_SURFACEDATA_SPECULAR_OCCLUSION (1302)
#define DEBUGVIEW_HAIR_SURFACEDATA_NORMAL (1303)
#define DEBUGVIEW_HAIR_SURFACEDATA_NORMAL_VIEW_SPACE (1304)
#define DEBUGVIEW_HAIR_SURFACEDATA_GEOMETRIC_NORMAL (1305)
#define DEBUGVIEW_HAIR_SURFACEDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1306)
#define DEBUGVIEW_HAIR_SURFACEDATA_SMOOTHNESS (1307)
#define DEBUGVIEW_HAIR_SURFACEDATA_AMBIENT_OCCLUSION (1308)
#define DEBUGVIEW_HAIR_SURFACEDATA_SPECULAR_TINT (1309)
#define DEBUGVIEW_HAIR_SURFACEDATA_DIFFUSION_PROFILE (1310)
#define DEBUGVIEW_HAIR_SURFACEDATA_SUBSURFACE_MASK (1311)
#define DEBUGVIEW_HAIR_SURFACEDATA_THICKNESS (1312)
#define DEBUGVIEW_HAIR_SURFACEDATA_TANGENT (1313)
#define DEBUGVIEW_HAIR_SURFACEDATA_ANISOTROPY (1314)

//
// UnityEngine.Experimental.Rendering.HDPipeline.Hair+BSDFData:  static fields
//
#define DEBUGVIEW_HAIR_BSDFDATA_MATERIAL_FEATURES (1350)
#define DEBUGVIEW_HAIR_BSDFDATA_DIFFUSE_COLOR (1351)
#define DEBUGVIEW_HAIR_BSDFDATA_FRESNEL0 (1352)
#define DEBUGVIEW_HAIR_BSDFDATA_AMBIENT_OCCLUSION (1353)
#define DEBUGVIEW_HAIR_BSDFDATA_SPECULAR_OCCLUSION (1354)
#define DEBUGVIEW_HAIR_BSDFDATA_SPECULAR_COLOR (1355)
#define DEBUGVIEW_HAIR_BSDFDATA_NORMAL_WS (1356)
#define DEBUGVIEW_HAIR_BSDFDATA_NORMAL_VIEW_SPACE (1357)
#define DEBUGVIEW_HAIR_BSDFDATA_GEOMETRIC_NORMAL (1358)
#define DEBUGVIEW_HAIR_BSDFDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1359)
#define DEBUGVIEW_HAIR_BSDFDATA_PERCEPTUAL_ROUGHNESS (1360)
#define DEBUGVIEW_HAIR_BSDFDATA_DIFFUSION_PROFILE (1361)
#define DEBUGVIEW_HAIR_BSDFDATA_SUBSURFACE_MASK (1362)
#define DEBUGVIEW_HAIR_BSDFDATA_THICKNESS (1363)
#define DEBUGVIEW_HAIR_BSDFDATA_USE_THICK_OBJECT_MODE (1364)
#define DEBUGVIEW_HAIR_BSDFDATA_TRANSMITTANCE (1365)
#define DEBUGVIEW_HAIR_BSDFDATA_TANGENT_WS (1366)
#define DEBUGVIEW_HAIR_BSDFDATA_BITANGENT_WS (1367)
#define DEBUGVIEW_HAIR_BSDFDATA_ROUGHNESS_T (1368)
#define DEBUGVIEW_HAIR_BSDFDATA_ROUGHNESS_B (1369)
#define DEBUGVIEW_HAIR_BSDFDATA_ANISOTROPY (1370)
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        ...
        case DEBUGVIEW_HAIR_BSDFDATA_SPECULAR_OCCLUSION:
            ...
            break;
        case DEBUGVIEW_HAIR_BSDFDATA_SPECULAR_COLOR:
