Shader "HDRenderPipeline/Hair"
{
    ...
    #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Hair/HairProperties.hlsl"
    ...
    SubShader
    {
        ...
        Tags{ "RenderPipeline" = "HDRenderPipeline" "RenderType" = "HDHairShader" }
        ...
        // Hair shader always render in forward
        Pass
        {
