...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    public class SubsurfaceScatteringManager
    {
        ...
        public void InitSSSBuffers(GBufferManager gbufferManager, RenderPipelineSettings settings)
        {
            ...
            if (settings.supportedRenderingPath == RenderPipelineSettings.SupportedRenderingPath.ForwardOnly) //forward only
            {
            ...
            if ((settings.supportedRenderingPath & RenderPipelineSettings.SupportedRenderingPath.DeferredOnly) != 0) //deferred or both
            {
