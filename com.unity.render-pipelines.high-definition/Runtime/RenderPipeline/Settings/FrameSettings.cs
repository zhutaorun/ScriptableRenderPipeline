...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class FrameSettings
    {
        ...
        // View
        public ShaderLitMode shaderLitMode = ShaderLitMode.Deferred; // TODO: Currently there is no way to strip the extra forward shaders generated by the shaders compiler, so we can switch dynamically.
        ...
        public static void InitializeFrameSettings(Camera camera, RenderPipelineSettings renderPipelineSettings, FrameSettings srcFrameSettings, ref FrameSettings aggregate)
        {
            ...
            {
                aggregate.shaderLitMode = ShaderLitMode.Forward;
            }
            else
            {
                switch (renderPipelineSettings.supportedRenderingPath)
                {
                    ...
                    case RenderPipelineSettings.SupportedRenderingPath.DeferredOnly:
                        aggregate.shaderLitMode = ShaderLitMode.Deferred;
                        break;
            ...
            aggregate.enableMSAA = srcFrameSettings.enableMSAA && renderPipelineSettings.supportMSAA && aggregate.shaderLitMode == ShaderLitMode.Forward;
        ...
        public void ConfigureMSAADependentSettings()
        {
            if (enableMSAA)
            {
                ...
                shaderLitMode = ShaderLitMode.Forward;
        ...
        public static void RegisterDebug(string menuName, FrameSettings frameSettings)
        {
            ...
            new DebugUI.Widget[]
            {
                ...
                new DebugUI.Foldout
                {
                    ...
                    children =
                    {
                        new DebugUI.EnumField { displayName = "Shader Lit Mode", getter = () => (int)frameSettings.shaderLitMode, setter = value => frameSettings.shaderLitMode = (ShaderLitMode)value, autoEnum = typeof(ShaderLitMode)},
